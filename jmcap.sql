...
CREATE TABLE `orders` (
  ...
  `fees` float(12,6) DEFAULT NULL,
  `price` float(12,6) DEFAULT NULL,
  `stop_price` float(12,6) DEFAULT NULL,
  `upper_stop_price` float(12,6) DEFAULT NULL,
  `size` float(12,6) DEFAULT NULL,
  `funds` float(12,6) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=139221 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dump completed on 2021-11-12 13:56:50
