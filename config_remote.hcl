...

{
  "0": 0
# ! -------------------------------------------------
# ! most comment edit for live config
# ! -------------------------------------------------
#  ,"sounds": true
#  ,"offline": true
...
#  ,"datatype": "backtest"
  ...
  ,"datalength":216     #! MUST be > data-window * 2 - for random/backtest data only:: @5m 1d=288. 1w=2016, 1m=8640
#  ,"datalength":588
...
#    ,"bail_option_1":true
  ...
  #+ │ STARTUP ONLY
  #+ └────────────────────────────────────┘
  ,"interval": 10.00      #! can't be 0 or the 'plt' non-blocking pause will loop forever
#  ,"figsize":[18,10]
  ,"figsize":[6,4]
  #+ ┌────────────────────────────────────┐
  #+ │ DATA
...
#  ,"MACD_src":   "Low"
  ...
  ,"mbpfilter": {
                 ...
                 "mx" : [  #! this is not used when normalizing the data, mainused for accentuating or damping certain bands
                    12,    # * inverse of 0.083333, center val for band 1
                    4,     # * inverse of 0.250000, center val for band 2
                    2.4,   # * inverse of 0.416667, center val for band 3
                    1.714, # * inverse of 0.583333, center val for band 4
                    1.333, # * inverse of 0.750000, center val for band 5
                    1.091  # * inverse of 0.916667, center val for band 6
                  ],
                 "Wn": [
...
#  ,"loc_plots_hilo":       4       ,"plots_hilo": true
  ,"loc_plots_macd":       5       ,"plots_macd": true
...
#  ,"loc_plots_siglf":  1        ,"plots_siglf": true
  ...
  ,"loc_plots_sigffmb2":  2        ,"plots_sigffmb2": true, "plots_sigffmb2_hide": true
  ,"loc_plots_sigffmap2":  2        ,"plots_sigffmap2": true
  #+ ┌────────────────────────────────────┐
  #+ │ PLOT STYLES
  #+ └────────────────────────────────────┘
...
#  ,"EMA_2style":     {"color":"cyan",   "width": 1, "alpha": 1}
  ...
  ,"ffmapstyle":      {"color":"green", "width": 1, "alpha":1.0}
  ,"ffmaplolimstyle": {"color":"green", "linewidth": 1, "alpha":1.0}
  ,"ffmaphilimstyle": {"color":"green", "linewidth": 1, "alpha":0.3}

  ,"ffmap2style":       {"color":"red", "width": 1, "alpha":1.0}
  ,"ffmap2lolimstyle":  {"color":"red", "linewidth": 1, "alpha":1.0}
  ,"ffmap2hilimstyle":  {"color":"red", "linewidth": 1, "alpha":0.3}
