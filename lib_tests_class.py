...
class Tests:
    def __init__(self, cvars, dfl, df, **kwargs):
        ...
        self.Lunder3BBlow = self.compare(price=self.LOW, type='lt', against=self.BB_LOW_0) and \
                            self.compare(price=self.LOW, type='lt', against=self.BB_LOW_1) and \
                            self.compare(price=self.LOW, type='lt', against=self.BB_LOW_2)
        # + * CLOSE is below all three BB low bands
        self.Cunder3BBlow = self.compare(price=self.CLOSE, type='lt', against=self.BB_LOW_0) and \
                            self.compare(price=self.CLOSE, type='lt', against=self.BB_LOW_1) and \
                            self.compare(price=self.CLOSE, type='lt', against=self.BB_LOW_2)
        # + * CLOSE is above all three BB high bands
        self.Cover3BBhigh = self.compare(price=self.CLOSE, type='gt', against=self.BB_HIGH_0) and \
                            self.compare(price=self.CLOSE, type='gt', against=self.BB_HIGH_1) and \
                            self.compare(price=self.CLOSE, type='gt', against=self.BB_HIGH_2)
        # + * HIGH is above all three BB high bands
        self.Hover3BBhigh = self.compare(price=self.HIGH, type='gt', against=self.BB_HIGH_0) and \
                            self.compare(price=self.HIGH, type='gt', against=self.BB_HIGH_1) and \
    ...
    def BUY_Llt3LowBands(self):
        FLAG = True
        FLAG = FLAG and self.compare(price=self.LOW, type='lt', against=self.BB_LOW_0)
        FLAG = FLAG and self.compare(price=self.LOW, type='lt', against=self.BB_LOW_1)
        FLAG = FLAG and self.compare(price=self.LOW, type='lt', against=self.BB_LOW_2)
        return FLAG
    # ! ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
    ...
    def BUY_CltMidBbavg(self):
        FLAG = True
        FLAG = FLAG and self.compare(price=self.CLOSE, type='lt', against=self.BB3_MID_AVG)
        return FLAG
    # ! ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
    ...
    def BUY_LltLowBbavg(self):
        FLAG = True
        FLAG = FLAG and self.compare(price=self.LOW, type='lt', against=self.BB3_LOW_AVG)
        return FLAG
    # ! ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
    def BUY_CltPctlim(self):
        FLAG = True
        FLAG = FLAG and self.compare(price=self.CLOSE, type='lt', against= self.AVG_PRICE * 0.995)
        return FLAG
    # * ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
    ...
    def SELL_CgtHiBbavg_CoA(self):
        FLAG = True
        FLAG = FLAG and self.CoA
        FLAG = FLAG and self.compare(price = self.CLOSE, type='gt', against = self.BB3_UP_AVG)
        return FLAG
    # * ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓
    ...
    def SELL_CgtPctlim(self):
        FLAG = True
        FLAG = FLAG and self.CoA
        FLAG = FLAG and self.compare(price = self.CLOSE, type='gt', against = self.AVG_PRICE * 1.005)
        return FLAG
